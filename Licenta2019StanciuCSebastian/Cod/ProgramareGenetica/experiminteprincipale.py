...
path2 = "C:\\Users\\stanc\\OneDrive\\Desktop\\MySmoteDataDoubled.csv"
...
def eval(individual):
    ...
    if safeDiv(2 * (precision * recall), (precision + recall)) > maxim:
        maxim = safeDiv(2 * (precision * recall), (precision + recall))
